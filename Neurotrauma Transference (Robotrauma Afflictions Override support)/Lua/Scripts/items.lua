local experimentalEffects = {
    ...
    fullheal = {
        weight = 5,
        afflictions = {
            {identifier = "bleeding", minstrength = -20, maxstrength = -100, limbspecific = true}, {identifier = "burn", minstrength = -20, maxstrength = -100, limbspecific = true}, {identifier = "explosiondamage", minstrength = -20, maxstrength = -100, limbspecific = true}, {identifier = "gunshotwound", minstrength = -20, maxstrength = -100, limbspecific = true}, {identifier = "bitewounds", minstrength = -20, maxstrength = -100, limbspecific = true}, {identifier = "lacerations", minstrength = -20, maxstrength = -100, limbspecific = true}, {identifier = "organdamage", minstrength = -20, maxstrength = -100, limbspecific = false}, {identifier = "cerebralhypoxia", minstrength = -20, maxstrength = -100, limbspecific = false}, {identifier = "bloodloss", minstrength = -20, maxstrength = -100, limbspecific = false}, {identifier = "blunttrauma", minstrength = -20, maxstrength = -100, limbspecific = true}, {identifier = "sepsis", minstrength = -200, maxstrength = -200, limbspecific = false}
        }
    },
    -- damage
...
Timer.Wait(function()
    ...
    NT.ItemMethods.experimentaltreatment = function(item, usingCharacter, targetCharacter, limb)
        ...
        -- endocrine booster
        if HF.Chance(1 / 25) then HF.ApplyEndocrineBoost(targetCharacter) end
    ...
    -- Triage tags
    local function IsTriageTagged(character) return HF.HasAffliction(character, "triagetag_green") or HF.HasAffliction(character, "triagetag_yellow") or HF.HasAffliction(character, "triagetag_red") or HF.HasAffliction(character, "triagetag_black") end
    ...
    NT.ItemMethods.manualtriagetag = function(item, usingCharacter, targetCharacter, limb)
        ...
        if not alreadyTagged then HF.RemoveItem(item) end
    end
    ...
    NT.ItemMethods.triagetag = function(item, usingCharacter, targetCharacter, limb)
        ...
        -- fractures
        if HF.HasAffliction(targetCharacter, "ll_fracture") or HF.HasAffliction(targetCharacter, "rl_fracture") or HF.HasAffliction(targetCharacter, "la_fracture") or HF.HasAffliction(targetCharacter, "ra_fracture") or HF.HasAffliction(targetCharacter, "h_fracture") or HF.HasAffliction(targetCharacter, "n_fracture") or HF.HasAffliction(targetCharacter, "t_fracture") then fuckedness = math.max(fuckedness + 5, 20) end

        -- arterial cuts
        if HF.HasAffliction(targetCharacter, "ll_arterialcut") or HF.HasAffliction(targetCharacter, "rl_arterialcut") or HF.HasAffliction(targetCharacter, "la_arterialcut") or HF.HasAffliction(targetCharacter, "ra_arterialcut") or HF.HasAffliction(targetCharacter, "h_arterialcut") or HF.HasAffliction(targetCharacter, "n_arterialcut") or HF.HasAffliction(targetCharacter, "t_arterialcut") then
...
Timer.Wait(function()
    ...
    NTCyb.ItemMethods.crowbar = function(item, usingCharacter, targetCharacter, limb)
        ...
        if (usingCharacter == targetCharacter) and not NTRT.IsRobot(targetCharacter) then
